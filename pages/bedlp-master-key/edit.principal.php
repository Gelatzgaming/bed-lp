...
<head>
    <title>Update Principal | SFAC Las Pinas</title>
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link disabled text-light">Edit Principal</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                ...
                <section class="content">
                    <div class="container-fluid pl-5 pr-5 pb-3">
                        <div class="card card-purple shadow-lg">
                            ...
                            <form action="userData/user.edit.principal.php <?php echo '?prin_id=' . $prin_id; ?>"
                                    ...
                                    <div class="row mb-4 mt-5">
                                        <div class="input-group col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="firstname"
                                                placeholder="Firstname" value="<?php echo $row['prin_fname']; ?>">
                                        </div>
                                        ...
                                        <div class="input-group col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="lastname"
                                                placeholder="Lastname" value="<?php echo $row['prin_lname']; ?>">
                                        </div>
                                        ...
                                        <div class="input-group col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="midname"
                                                placeholder="Middlename" value="<?php echo $row['prin_mname']; ?>">
                                        </div>
                                    </div>
