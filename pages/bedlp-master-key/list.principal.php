...
<head>
    <title>Principal List | SFAC Las Pinas</title>
                ...
                <section class="content">
                    <div class="container-fluid pl-5 pr-5 pb-3">
                        ...
                        <div class="col-12 mt-5">
                            <div class="card">
                                <div class="card-body">
                                    <h4 class="header-title">Principal List</h4>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><a href="edit.principal.php<?php echo '?prin_id=' . $id; ?>"
                                                        ...
                                                        <button type="button" class="btn btn-danger mx-1"
                                                            data-toggle="modal"
                                                            data-target="#delete<?php echo $row['prin_id'] ?>"><i
                                                                class="fa fa-trash"></i> Delete</button>
                                                    </td>
                                                </tr>
                                                <!-- Delete modal start -->
                                                <div class="modal fade" id="delete<?php echo $row['prin_id'] ?>">
                                                    <div class="modal-dialog modal-dialog-centered" role="document">
                                                        <div class="modal-content">
                                                            ...
                                                            <div class="modal-footer">
                                                                ...
                                                                <a href="userData/user.del.principal.php?prin_id=<?php echo $row['prin_id'] ?>"
