...
<head>
    <title>Admission Sign Up | SFAC Las Pinas</title>
                    ...
                    <div class="container-fluid pl-5 pr-5 pb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Add Admission</h4>
                                        <p class="text-muted font-14 mb-4">Fill up the forms.
                                        </p>
                                        <form action="./userData/user.add.admission.php" method="POST"
