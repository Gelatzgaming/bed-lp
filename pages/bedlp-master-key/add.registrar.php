...
<head>
    <title>Add Registrar| SFAC Las Pinas</title>
                    ...
                    <div class="container-fluid pl-5 pr-5 pb-3">
                        ...
                        <div class="row">
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        <h4 class="header-title">Add Registrar</h4>
                                        ...
                                        <form action="./userData/user.add.registrar.php" method="POST"
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <div class="custom-file">
                                                            <input type="file" class="custom-file-input" name="prof_img"
                                                                id="inputGroupFile01">
                                            ...
                                            <button type="submit" name="submit"
                                                class="btn btn-primary mb-3 mt-3 float-right">Add Registrar</button>
                                        </form>
                                    </div>
                                </div>
                            </div>
