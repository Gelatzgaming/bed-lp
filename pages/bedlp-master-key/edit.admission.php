...
if ($_SESSION['role'] == "Admission") {
    if ($admission_id != $_SESSION['admission_id']) {
        header('location: ../bedlp-404/page404.php');
    }
}

$_SESSION['get-admissionID'] = $admission_id;
?>
...
<head>
    <title>Update Admission | SFAC Las Pinas</title>
        ...
        <nav class="main-header navbar navbar-expand navbar-dark">
            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item d-none d-sm-inline-block">
                    <a href="#" class="nav-link disabled text-light">Edit Admission</a>
                </li>
                <li class="nav-item d-none d-sm-inline-block">
                ...
                <section class="content">
                    <div class="container-fluid pl-5 pr-5 pb-3">
                        <div class="card card-purple shadow-lg">
                            ...
                            <form
                                action="userData/user.edit.admission.php <?php echo '?admission_id=' . $admission_id; ?>"
                                    ...
                                    <div class="row mb-4 mt-5">
                                        <div class="input-group col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="firstname"
                                                placeholder="Firstname" value="<?php echo $row['admission_fname']; ?>">
                                        </div>
                                        ...
                                        <div class="input-group col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="lastname"
                                                placeholder="Lastname" value="<?php echo $row['admission_lname']; ?>">
                                        </div>
                                        ...
                                        <div class="input-group col-sm-4 mb-2">
                                            ...
                                            <input type="text" class="form-control" name="midname"
                                                placeholder="Middlename" value="<?php echo $row['admission_mname']; ?>">
                                        </div>
                                    </div>
            ...
            // alert 
            if (isset($_SESSION['success-admissionEdit'])) {
                echo "<script>
    $(function() {
...
title: 'Successfully Updated.'
            ...
            unset($_SESSION['success-admissionEdit']);
