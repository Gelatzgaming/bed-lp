...
if (isset($_POST['submit']) && $_SERVER['REQUEST_METHOD'] == "POST") {
    ...
    if ($failed != 0) {
        ...
        $insertUser = mysqli_query($conn, "INSERT INTO tbl_registrars (img, reg_fname, reg_lname, reg_mname, activation_code, email, username, password) VALUES ('$image', '$firstname', '$lastname', '$midname', '', '$email', '$username', '$hashpwd')") or die(mysqli_error($conn));
