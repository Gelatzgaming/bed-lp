...
<head>
    <title>Student Sign Up | SFAC Las Pinas</title>
                            ...
                            <div class="col-12 mt-5">
                                <div class="card">
                                    <div class="card-body">
                                        ...
                                        <form action="./userData/user.add.students.php" method="POST"
                                            ...
                                            <div class="row">
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        ...
                                                        <input class="form-control" type="text" placeholder="Student ID"
                                                            name="studID" id="example-text-input"
                                                            value="<?php
                                                ...
                                                <div class="col-md-6">
                                                    <div class="form-group">
                                                        <label for="example-email-input" class="col-form-label">Learner
                                                            Reference Number(LRN)</label>
                                                        <input class="form-control" type="text"
                                                            placeholder="Learner Reference Number(LRN)" name="lrn"
